...
export class LoanDefault extends ethereum.Event {
...
export class UpdateTotalMinted extends ethereum.Event {
...
export class Loan extends ethereum.SmartContract {
  ...
  try_flags(): ethereum.CallResult<Loan__flagsResult> {
  ...
  proofs(param0: i32): BigInt {
    let result = super.call("proofs", "proofs(uint8):(uint256)", [
  ...
  try_proofs(param0: i32): ethereum.CallResult<BigInt> {
    let result = super.tryCall("proofs", "proofs(uint8):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(param0))
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  supportsProof(_proof: i32): boolean {
    let result = super.call("supportsProof", "supportsProof(uint24):(bool)", [
      ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(_proof))
    ]);

    return result[0].toBoolean();
  }

  try_supportsProof(_proof: i32): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "supportsProof",
      "supportsProof(uint24):(bool)",
      [ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(_proof))]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  loanVariables(): Loan__loanVariablesResult {
    let result = super.call(
      "loanVariables",
      "loanVariables():(uint256,uint256,uint256,uint256,uint256,bytes32,bytes32,address,address,address,address,address,address)",
      []
    );
  ...
  try_loanVariables(): ethereum.CallResult<Loan__loanVariablesResult> {
    let result = super.tryCall(
      "loanVariables",
      "loanVariables():(uint256,uint256,uint256,uint256,uint256,bytes32,bytes32,address,address,address,address,address,address)",
      []
...
export class SetProofsCall extends ethereum.Call {
...
export class ApproveAccessCall extends ethereum.Call {
...
export class SettleLoanCall extends ethereum.Call {
...
export class ConfidentialMintCall extends ethereum.Call {
...
export class AdjustInterestBalanceCall extends ethereum.Call {
...
export class MarkLoanAsDefaultCall extends ethereum.Call {
